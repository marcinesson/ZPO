package pl.plywanie.plywanie.config;
...
import pl.plywanie.plywanie.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "INSTRUCTOR") ? "/instructor/enrollments" : "/swimming";
    }
