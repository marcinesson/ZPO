...
public class CateringOrderService {
    private final CateringTeamRepository resourceRepository;
    private final CateringOrderRepository recordRepository;
    private final AppUserService appUserService;

    public List<CateringTeam> getAllResources() {
        return resourceRepository.findAll();
    }

    public List<CateringOrder> getAllRecords() {
        return recordRepository.findAll();
    }

    public List<CateringOrder> getMine() {
        return recordRepository.findByUserId(appUserService.getLoggedInUser().getId());
    }

    public CateringTeam findBestResource(DietType category, int requiredCapacity,
        ...
        return resourceRepository.findAll().stream()
                .filter(CateringTeam::isAvailable)
    ...
    @Transactional
    public CateringOrder createRecord(DietType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
        CateringTeam resource = findBestResource(category, requiredCapacity, minQuality,
                taskUnits, priority, startTime, endTime);
        CateringOrder record = new CateringOrder();
    ...
    public BigDecimal calculateScore(CateringTeam resource, int requiredCapacity,
    ...
    public BigDecimal calculatePrice(CateringTeam resource, int taskUnits, int priority) {
    ...
    public int calculateRequiredHours(CateringTeam resource, int taskUnits) {
    ...
    private void validateSearch(DietType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
