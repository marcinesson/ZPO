package pl.catering.catering.config;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/kitchen/**").hasRole("KITCHEN_MANAGER")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "KITCHEN_MANAGER") ? "/kitchen/orders" : "/catering";
    }
