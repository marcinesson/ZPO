package pl.telefony.telefony.config;
...
import pl.telefony.telefony.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") ? "/technician/orders" : "/phone-repairs";
    }
