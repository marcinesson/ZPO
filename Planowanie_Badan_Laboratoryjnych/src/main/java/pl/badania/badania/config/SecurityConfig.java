package pl.badania.badania.config;
...
import pl.badania.badania.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/lab/**").hasRole("LAB_TECH")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "LAB_TECH") ? "/lab/tests" : "/tests";
    }
