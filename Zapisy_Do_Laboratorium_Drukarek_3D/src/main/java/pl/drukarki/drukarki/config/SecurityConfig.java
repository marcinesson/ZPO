package pl.drukarki.drukarki.config;
...
import pl.drukarki.drukarki.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") ? "/technician/prints" : "/prints";
    }
