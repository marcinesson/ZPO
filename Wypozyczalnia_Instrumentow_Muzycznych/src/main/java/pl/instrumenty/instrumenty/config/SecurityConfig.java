package pl.instrumenty.instrumenty.config;
...
import pl.instrumenty.instrumenty.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "CURATOR") ? "/curator/rentals" : "/instruments";
    }
