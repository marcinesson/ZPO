package pl.kosmetyczka.kosmetyczka.config;
...
import pl.kosmetyczka.kosmetyczka.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/beautician/**").hasRole("BEAUTICIAN")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "BEAUTICIAN") ? "/beautician/appointments" : "/beauty";
    }
