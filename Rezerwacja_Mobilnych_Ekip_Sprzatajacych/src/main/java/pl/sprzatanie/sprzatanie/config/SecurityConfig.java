package pl.sprzatanie.sprzatanie.config;
...
import pl.sprzatanie.sprzatanie.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "COORDINATOR") ? "/coordinator/orders" : "/cleaning";
    }
