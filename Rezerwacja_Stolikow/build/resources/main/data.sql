...
INSERT INTO restaurant_table (name,capacity,price,available) SELECT 'Basic',2,50.00,true WHERE NOT EXISTS (SELECT 1 FROM restaurant_table WHERE name='Basic');
INSERT INTO restaurant_table (name,capacity,price,available) SELECT 'Premium',5,100.00,true WHERE NOT EXISTS (SELECT 1 FROM restaurant_table WHERE name='Premium');
