...
public class WashReservationService {
    private final WashBayRepository resourceRepository;
    private final WashReservationRepository recordRepository;
    private final AppUserService appUserService;

    public List<WashBay> getAllResources() {
        return resourceRepository.findAll();
    }

    public List<WashReservation> getAllRecords() {
        return recordRepository.findAll();
    }

    public List<WashReservation> getMine() {
        return recordRepository.findByUserId(appUserService.getLoggedInUser().getId());
    }

    public WashBay findBestResource(WashType category, int requiredCapacity,
    ...
    @Transactional
    public WashReservation createRecord(WashType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
        WashBay resource = findBestResource(category, requiredCapacity, minQuality,
                taskUnits, priority, startTime, endTime);
        WashReservation record = new WashReservation();
    ...
    public BigDecimal calculateScore(WashBay resource, int requiredCapacity,
    ...
    public BigDecimal calculatePrice(WashBay resource, int taskUnits, int priority) {
    ...
    public int calculateRequiredHours(WashBay resource, int taskUnits) {
    ...
    private void validateSearch(WashType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
