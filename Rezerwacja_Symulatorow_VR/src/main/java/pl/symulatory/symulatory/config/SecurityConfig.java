package pl.symulatory.symulatory.config;
...
import pl.symulatory.symulatory.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "INSTRUCTOR") ? "/instructor/sessions" : "/simulators";
    }
