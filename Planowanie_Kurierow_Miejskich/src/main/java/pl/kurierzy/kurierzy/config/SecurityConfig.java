package pl.kurierzy.kurierzy.config;
...
import pl.kurierzy.kurierzy.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "DISPATCHER") ? "/dispatcher/deliveries" : "/deliveries";
    }
