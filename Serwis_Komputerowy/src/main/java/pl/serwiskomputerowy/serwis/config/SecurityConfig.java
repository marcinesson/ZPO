package pl.serwiskomputerowy.serwis.config;
...
import pl.serwiskomputerowy.serwis.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TECHNICIAN") || hasRole(authentication, "ADMIN")
                ? "/technician/tickets"
                : "/tickets";
    }
