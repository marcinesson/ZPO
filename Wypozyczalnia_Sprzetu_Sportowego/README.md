# Wypozyczalnia_Sprzetu_Sportowego

Projekt zaliczeniowy Spring Boot + Vaadin.

- UI klienta: `/equipment`
- Panel roli wyzszej: `/staff/rentals`
- Swagger: `/swagger-ui.html`
- REST POST: `/api/equipment`
- Baza PostgreSQL: `wypozyczalnia_sprzetu_sportowego`
