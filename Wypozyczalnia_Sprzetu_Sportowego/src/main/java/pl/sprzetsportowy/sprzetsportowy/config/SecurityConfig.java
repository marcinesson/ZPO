package pl.sprzetsportowy.sprzetsportowy.config;
...
import pl.sprzetsportowy.sprzetsportowy.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "STAFF") ? "/staff/rentals" : "/equipment";
    }
