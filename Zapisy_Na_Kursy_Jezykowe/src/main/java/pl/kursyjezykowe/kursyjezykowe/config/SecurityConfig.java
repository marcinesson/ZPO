package pl.kursyjezykowe.kursyjezykowe.config;
...
import pl.kursyjezykowe.kursyjezykowe.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "TEACHER") ? "/teacher/enrollments" : "/courses";
    }
