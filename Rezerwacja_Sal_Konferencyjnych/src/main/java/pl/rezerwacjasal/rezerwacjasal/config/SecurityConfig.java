package pl.rezerwacjasal.rezerwacjasal.config;
...
import pl.rezerwacjasal.rezerwacjasal.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "ADMIN") ? "/admin/rooms" : "/rooms";
    }
