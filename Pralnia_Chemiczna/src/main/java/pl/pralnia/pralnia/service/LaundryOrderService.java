package pl.pralnia.pralnia.service;
...
public class LaundryOrderService {
    private final LaundryLineRepository resourceRepository;
    private final LaundryOrderRepository recordRepository;
    private final AppUserService appUserService;

    public List<LaundryLine> getAllResources() {
        return resourceRepository.findAll();
    }

    public List<LaundryOrder> getAllRecords() {
        return recordRepository.findAll();
    }

    public List<LaundryOrder> getMine() {
        return recordRepository.findByUserId(appUserService.getLoggedInUser().getId());
    }

    public LaundryLine findBestResource(LaundryType category, int requiredCapacity,
        ...
        return resourceRepository.findAll().stream()
                .filter(LaundryLine::isAvailable)
    ...
    @Transactional
    public LaundryOrder createRecord(LaundryType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
        LaundryLine resource = findBestResource(category, requiredCapacity, minQuality,
                taskUnits, priority, startTime, endTime);
        LaundryOrder record = new LaundryOrder();
    ...
    public BigDecimal calculateScore(LaundryLine resource, int requiredCapacity,
    ...
    public BigDecimal calculatePrice(LaundryLine resource, int taskUnits, int priority) {
    ...
    public int calculateRequiredHours(LaundryLine resource, int taskUnits) {
    ...
    private void validateSearch(LaundryType category, int requiredCapacity,
            int minQuality, int taskUnits, int priority, LocalDateTime startTime, LocalDateTime endTime) {
