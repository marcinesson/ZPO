package pl.pralnia.pralnia.config;
...
import pl.pralnia.pralnia.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/worker/**").hasRole("LAUNDRY_WORKER")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "LAUNDRY_WORKER") ? "/worker/orders" : "/laundry";
    }
