package pl.biblioteka.biblioteka.config;
...
import pl.biblioteka.biblioteka.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "LIBRARIAN") ? "/librarian/loans" : "/books";
    }
