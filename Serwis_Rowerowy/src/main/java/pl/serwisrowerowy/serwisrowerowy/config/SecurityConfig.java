package pl.serwisrowerowy.serwisrowerowy.config;
...
import pl.serwisrowerowy.serwisrowerowy.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "MECHANIC") ? "/mechanic/orders" : "/repairs";
    }
