package pl.studio.studio.config;
...
import pl.studio.studio.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/engineer/**").hasRole("SOUND_ENGINEER")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "SOUND_ENGINEER") ? "/engineer/sessions" : "/studios";
    }
