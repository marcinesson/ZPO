package pl.stroje.stroje.config;
...
import pl.stroje.stroje.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/wardrobe/**").hasRole("WARDROBE")
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "WARDROBE") ? "/wardrobe/rentals" : "/costumes";
    }
