package pl.przeprowadzki.przeprowadzki.config;
...
import pl.przeprowadzki.przeprowadzki.repository.AppUserRepository;
...
public class SecurityConfig {
    ...
    private String resolveRedirectUrl(Authentication authentication) {
        return hasRole(authentication, "COORDINATOR") ? "/coordinator/orders" : "/moving";
    }
